...
from utils.utils import fix_random_seed, cal_acc_comb, data_loader, cal_bca_comb, cal_acc_online, TTA, TTA_stack
...
def train_target(args):
        ...
        while iter_num < max_iter:
            ...
            if iter_num % interval_iter == 0 or iter_num == max_iter:
                ...
                if args.paradigm == 'MI':
                    ...
                    #log_str = 'Task: {}, Iter:{}/{}; BCA = {:.2f}%'.format(args.task_str, int(iter_num // len(dset_loaders["source-Imbalanced"])), int(max_iter // len(dset_loaders["source-Imbalanced"])), acc_t_te)
                    args.log.record(log_str)
                    print(log_str)
    ...
    #           './runs/' + str(args.data_name) + '/' + str(args.backbone) + '_S' + str(args.idt) + '_seed' + str(args.SEED) + '_Imbalanced' + '.ckpt')
    ...
    if args.paradigm == 'MI':
        #acc_t_te, y_pred = TTA(dset_loaders["Target-Online-Imbalanced"], base_network, args)
        acc_t_te, y_pred = TTA(dset_loaders["Target-Online-Imbalanced"], base_network, args, balanced=False)
...
if __name__ == '__main__':
    ...
    for data_name in data_name_list:
        ...
        args.data = data_name
        args.method = 'Imbsingle-TTA-T-TIME-Wu-AUC'
        #args.method = 'Imbsingle-TTA-BN-adapt-AUC'
