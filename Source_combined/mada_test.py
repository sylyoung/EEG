...
from utils.dataloader import read_mi_combine_tar, read_seed_combine_tar, read_seizure_combine_srcsel
...
def train_target(args):
    if args.data in ['SEED', 'SEED4']:
        ...
        X_src, y_src, X_tar, y_tar = read_seizure_combine_srcsel(args)
    else:
    ...
    while iter_num < max_iter:
        ...
        classifier_loss = CELabelSmooth_raw(num_classes=args.class_num, epsilon=args.smooth)(outputs_source,
                                                                                             labels_source)
        total_loss = args.lamda * transfer_loss + classifier_loss
