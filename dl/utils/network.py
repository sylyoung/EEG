...
try:
    ...
    from dl.models.EEGNet import EEGNet_feature, EEGNet, EEGNetCNNFusion, EEGNetDouble, EEGNetSiameseFusionFeature
    from dl.models.ShallowConvNet import ShallowConvNet, ShallowConvNet_feature
    from dl.models.FC import FC, FC_xy, FC_cat, FC_cat_xy, FC_xy_batch
