...
from utils.dataloader import read_mi_combine_tar, read_seed_combine_tar, read_ch_combine_srcbest
from utils.utils import lr_scheduler_full, fix_random_seed, cal_acc_comb, data_loader
from utils.loss import MultipleKernelMaximumMeanDiscrepancy, GaussianKernel, FocalLoss, lmmd
...
def train_target(args):
    if args.data in ['SEED', 'SEED4']:
        ...
        X_src, y_src, X_tar, y_tar, X_sb, y_sb, trade_off = read_ch_combine_srcbest(args)
    else:
    ...
    while iter_num < max_iter:
        ...
        total_loss = classifier_loss + args.lamda1 * discrepancy_loss + args.lamda2 * args.sbloss_trade_off * sb_loss
        ...
        if iter_num % interval_iter == 0 or iter_num == max_iter:
            ...
            print(log_str)
            print(classifier_loss.item(), discrepancy_loss.item(), sb_loss.item())
