...
def train_target(args):
    ...
    while iter_num < max_iter:
        ...
        # class_weight = tr.tensor([1., 9.315], dtype=tr.float32).cuda()  # class imbalance
        ...
        total_loss = classifier_loss + args.lamda1 * transfer_loss + args.lamda2 * args.w * sb_loss

        optimizer_f.zero_grad()
        optimizer_c.zero_grad()
        total_loss.backward()  # whole loss backpropagation
        optimizer_f.step()
        optimizer_c.step()
