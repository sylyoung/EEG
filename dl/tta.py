...
def train_target(args):
    ...
    if args.paradigm == 'MI':
        ...
        acc_t_te, _ = cal_bca_comb(dset_loaders["Target"], base_network, args=args)
    ...
    torch.save(base_network.state_dict(),
               './runs/' + str(args.data_name) + '/' + str(args.backbone) + '_S' + str(args.idt) + '_seed' + str(args.SEED) + '_adapted' + '.ckpt')
