...
from utils.utils import fix_random_seed, cal_acc_comb, data_loader, cal_bca_comb, cal_acc_online, TTA_ensemble, TTA_ensemble_balanced
...
def train_target(args):
    ...
    if args.paradigm == 'MI':
        acc_t_te, y_pred = TTA_ensemble_balanced(dset_loaders["Target-Online-Imbalanced"], base_networks, args, balanced=False)
...
if __name__ == '__main__':
    ...
    for data_name in data_name_list:
        ...
        args.data = data_name
        args.method = 'TTA-IM-Ens-Balanced'
