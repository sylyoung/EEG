...
def psd2(x, fs=1.0, window='hanning', nperseg=None, noverlap=None, nfft=None,
    ...
    by dividing the fts_labels_r3 into overlapping segments, computing a modified
    ...
    show : bool, optional (default = False)
        True (1) plots fts_labels_r3 in a matplotlib figure.
        False (0) to not plot.
    ...
    the signal power, while not over counting any of the fts_labels_r3.  Narrower
...
def _plot(x, fs, f, P, mpf, fmax, fpcntile, scales, xlim, units, ax):
    """Plot results of the psd2 function, see its help."""
    try:
