...
from utils.dataloader import read_mi_combine_tar, read_seed_combine_tar, read_seizure_combine_srcbest
...
def train_target(args):
    ...
    while iter_num < max_iter:
        ...
        inputs_source, labels_source, inputs_sb, labels_sb = inputs_source.cuda(), labels_source.cuda(),  inputs_sb.cuda(), labels_sb.cuda()
        ...
        args.w = trade_off
        lamda = 1  # balance sb loss and ce loss
        total_loss = classifier_loss + lamda * args.w * sb_loss
        ...
        if iter_num % interval_iter == 0 or iter_num == max_iter:
            ...
            print(log_str)
            print(classifier_loss.item(), sb_loss.item())
