...
from utils.dataloader import read_mi_combine_tar, read_seed_combine_tar, read_seizure_combine_sbmada
...
def train_target(args):
    ...
    while iter_num < max_iter:
        ...
        # src best loss
        args.lamda1 = 1  # trade off 参数1
        args.lamda2 = 1  # trade off 参数2
        args.w = trade_off
        sb_loss = lmmd(source=features_source, target=features_sb, s_label=labels_source, t_label=labels_sb)

        total_loss = classifier_loss + args.lamda1 * discrepancy_loss + args.lamda2 * args.w * sb_loss
