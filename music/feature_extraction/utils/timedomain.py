...
from pywt import wavedec # 此处解决方法是pip install pywavelets
import numpy as np
import pandas as pd
import itertools
import math
...
class timedomain:
   def __init__(self, eegData):
       ...
       #print(self.fts_labels_r3.shape)
   ...
   def time_main(self, mysteps = 5):
       ...
       time_feature =[cv,nl,rmsAmp,num,zcr,kurt,skew,ac,mb,cp,power,mean,d1,nd1,d2,nd2] # 16 time domain feature.
