...
from utils.utils import fix_random_seed, cal_acc_comb, data_loader, cal_bca_comb, cal_acc_online, BN_adapt
...
def train_target(args):
    ...
    '''
    if args.paradigm == 'MI':
        acc_t_te, y_pred = BN_adapt(dset_loaders["Target-Online"], base_network, args)
        #acc_t_te, y_pred = cal_acc_TENT(dset_loaders["Target-Online-Imbalanced"], base_network, args, balanced=False)
        log_str = 'Task: {}, TTA Acc = {:.2f}%'.format(args.task_str, acc_t_te)
        args.log.record(log_str)
        print(log_str)
    elif args.paradigm == 'ERP':
        acc_t_te, y_pred = BN_adapt(dset_loaders["Target-Online"], base_network, args, balanced=False)
...
if __name__ == '__main__':
    ...
    for data_name in data_name_list:
        ...
        args = argparse.Namespace(feature_deep_dim=feature_deep_dim, lr=0.001, trial_num=trial_num,
                                  ...
                                  test_batch=test_batch, steps=steps)
