...
from utils.dataloader import read_mi_combine_tar, read_seed_combine_tar, read_ch_combine_srcsel, read_ch_combine_tar
from utils.utils import lr_scheduler_full, fix_random_seed, cal_acc_comb, data_loader
from utils.loss import CELabelSmooth_raw
...
def train_target(args):
    ...
    while iter_num < max_iter:
        ...
        # class_weight = tr.tensor([1., 5], dtype=tr.float32).cuda()  # class imbalance
        ...
        if iter_num % interval_iter == 0 or iter_num == max_iter:
            ...
            print(log_str)
            print('loss_output: ', classifier_loss.item())  # output the loss
            base_network.train()
