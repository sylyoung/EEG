...
class nonlinear:
    def __init__(self, eegData, myfs):
        # self.fts_labels_r3 = eegData  # 1*n
    ...
    def LLE(self, tau, n, T):
        ...
        Notes
        ----------
        A n-dimensional trajectory is first reconstructed from the observed fts_labels_r3 by
        ...
        practical method for calculating largest Lyapunov exponents from small fts_labels_r3
        ...
        d_ij = numpy.sum(numpy.log(neighbor_dists.data + 1e-5), axis=1)
